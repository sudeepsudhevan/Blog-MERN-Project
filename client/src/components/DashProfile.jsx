...
export default function DashProfile() {
    ...
    const handleSubmit = async (e) => {
        ...
        if (imageFileUploading) {
            setUpdateUserError('Please wait while image is being uploading.');
            return;
        }
        try {
        ...
        <div className='max-w-lg mx-auto p-3 w-full'>
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-4">
                ...
                <div className="relative w-32 h-32 self-center cursor-pointer shadow-md overflow-hidden rounded-full"
                    ...
                    <img src={imageFileUrl || currentUser?.profilePicture} alt="user profile photo"
            ...
            <Modal show={showModal} onClose={() => setShowModal(false)} size="md" popup className={theme}>
                <Modal.Header />
                <Modal.Body>
