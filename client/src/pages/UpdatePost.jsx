...
export default function UpdatePost() {
    ...
    const { postId } = useParams(); // /update-post/:[postId]
        ...
        <div className="p-3 max-w-3xl mx-auto min-h-screen">
            ...
            <form className="flex flex-col gap-4" onSubmit={handleSubmit}>
                <div className="flex flex-col gap-4 sm:flex-row justify-between">
                    <TextInput value={formData.title} type="text" id="title" placeholder="Title" required onChange={(e) => setFormData({ ...formData, title: e.target.value })}
                ...
                <div className="flex gap-4 items-center justify-between border-4 border-teal-500 border-dotted p-3">
                    ...
                    <Button type="button" gradientDuoTone='purpleToBlue' onClick={handleUploadImage} disabled={imageUploadProgress}
                        size='sm' outline>
                        {imageUploadProgress ?
                ...
                <ReactQuill value={formData.content} theme="snow" onChange={
                    (value) => setFormData({ ...formData, content: value })
                } placeholder="Write your post here..." className="h-72 mb-12" required />
